...
export const VIEWBOX = "0 0 240 860";
...
export const SPEAKER = { cx: 120, top: 744, rows: 6, cols: 6, gapX: 8, gapY: 7, dotR: 1.85 };

/** RGB 라이트 링: 하단 보라색 캡 위의 얇은 청색 라이트 밴드 */
export const RGB_RING = { cx: 120, cy: 820, width: 90, height: 14, r: 7 };
...
export const FRONT_KEYS: KeyPos[] = [
  ...
  { kind: "pill", id: "SHARP", cx: 176, cy: 461, w: 24, h: 14 },
  { kind: "pill", id: "FLAT", cx: 176, cy: 486, w: 24, h: 14 },
  { kind: "circle", id: "K4", cx: 120, cy: 542, r: 19 },
  { kind: "circle", id: "K5", cx: 120, cy: 596, r: 19 },
  { kind: "circle", id: "K6", cx: 120, cy: 650, r: 19 },
  { kind: "circle", id: "K7", cx: 120, cy: 704, r: 18 },
];
...
export const THUMB_HOOK = { cx: 120, cy: 545, w: 42, h: 28 }; // ㄱ자 돌기
export const STRAP_RING = { cx: 120, cy: 775, r: 7 };
...
export const PARTS: PartDef[] = [
  ...
  { id: "noteKeys", face: "front", kor: "음표 키 7개", desc: "위 3개는 왼손, 아래 4개는 오른손. 터치 키라 힘이 필요 없어요.", cx: 120, cy: 500, rx: 54, ry: 238 },
  { id: "semitoneKeys", face: "front", kor: "♯/♭ 반음 키", desc: "왼손 새끼손가락 자리. 누르는 동안 반음을 올리고 내려요.", cx: 176, cy: 474, rx: 18, ry: 30 },
  { id: "speaker", face: "front", kor: "스피커", desc: "소리가 나오는 곳이에요.", cx: 120, cy: 762, rx: 32, ry: 26 },
  { id: "ring", face: "front", kor: "RGB 라이트 링", desc: "연주할 때 무지개빛으로 빛나는 라이트예요.", cx: 120, cy: 820, rx: 48, ry: 14 },
  ...
  { id: "thumbHook", face: "back", kor: "엄지 후크", desc: "오른손 엄지를 아래에 받쳐 악기를 지탱해요.", cx: 120, cy: 545, rx: 30, ry: 22 },
  { id: "strapRing", face: "back", kor: "스트랩 링", desc: "목줄을 거는 고리. 걸면 떨어뜨릴 걱정이 없어요.", cx: 120, cy: 775, rx: 16, ry: 14 },
];
